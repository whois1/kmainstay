...
{"$schema":"https://json-schema.org/draft/2020-12/schema","$defs":{
  ...
  "Message":{"type":"object","required":["id","conversation_id","author_id","author_name","author_kind","body","created_at","sequence","mentions"],"properties":{"id":{"type":"string"},"conversation_id":{"type":"string"},"author_id":{"type":"string"},"author_name":{"type":"string"},"author_kind":{"enum":["human","bot"]},"body":{"type":"string","minLength":1,"maxLength":20000},"client_id":{"type":"string"},"created_at":{"type":"string","format":"date-time"},"sequence":{"type":"integer","minimum":1},"mentions":{"type":"array","items":{"$ref":"#/$defs/MentionedUser"},"uniqueItems":true}}},
